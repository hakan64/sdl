...
//globals
static char piece0[5][5] = {{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EBLOCK,EEMPTY},
							{EEMPTY,EBLOCK,EBLOCK,EBLOCK,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY}};
static char piece1[5][5] = {{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EBLOCK,EEMPTY,EEMPTY},
							{EEMPTY,EBLOCK,EBLOCK,EBLOCK,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY}};
static char piece2[5][5] = {{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EBLOCK,EBLOCK,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EBLOCK,EBLOCK,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY}};
static char piece3[5][5] = {{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EBLOCK,EBLOCK,EEMPTY},
							{EEMPTY,EBLOCK,EBLOCK,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY}};
static char piece4[5][5] = {{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EBLOCK,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EBLOCK,EBLOCK,EBLOCK,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY}};
static char piece5[5][5] = {{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EBLOCK,EBLOCK,EEMPTY},
							{EEMPTY,EEMPTY,EBLOCK,EBLOCK,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY}};
static char piece6[5][5] = {{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
							{EEMPTY,EEMPTY,EEMPTY,EEMPTY,EEMPTY},
...
bool checkCollision(int xinc,int yinc)
{
	forij
	{
		if(currPiece[i][j] == EBLOCK && map[i+pieceX+xinc][j+pieceY+yinc] != 0)
			return true;
	}
	return false;
}
